...
/**
 * Soft glow disc behind the bottle. `color` sets the tint
 * (cool silver-blue for moonlight, amber for the warm look).
 */
export default function BacklightHalo({
  position = [1.1, 0.6, -3.2],
  scale = [12, 12, 1],
  color = '#8fa6d6',
  opacity = 0.42,
}) {
  const haloTexture = useMemo(() => {
    ...
    grad.addColorStop(0.0, rgba(1.0, 0.52))
    grad.addColorStop(0.18, rgba(0.85, 0.32))
    grad.addColorStop(0.42, rgba(0.55, 0.15))
    grad.addColorStop(0.68, rgba(0.25, 0.05))
